...
//                "جاري ...","عملية التفريغ", false, false);
      ...
      //  String url = "https://sultantec.com/bisha/del_fev.php?a="+in;
        String url = "http://sultantec.com/haraj_elbel/Check_Favotite.php";
    ...
    private void Add_fav() {
      ...
      //  String in =getIntent().getStringExtra("phone");;
        ...
        String url = "http://sultantec.com/haraj_elbel/Add_Favorite.php";
    ...
    private void coment_send() {
        ...
        String url = "http://sultantec.com/haraj_elbel/Add_Comment.php";
    ...
    private void loadcomment() {
        ...
        * */
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,"http://sultantec.com/haraj_elbel/Product_Details.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
