        ...
        dialogButtonc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              if(name22.equals("الالبل")){
                  ...
                  startActivity(alvvwefrerxx);
                    }else if(name22.equals("مستلزمات الالبل")){
                  ...
                  alvvwefrerxx.putExtra("key_p", name223);
                  startActivity(alvvwefrerxx);
              }else if(name22.equals("ناقلات الالبل")){
...
//                "جاري ...","عملية التفريغ", false, false);
        ...
        String url = "http://sultantec.com/haraj_elbel/New_Notification.php";
