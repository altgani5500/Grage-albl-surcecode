...
//
        ...
        settings = getSharedPreferences("BISC", 0);
        final String phone2 = settings.getString("go1", "44");
        String URL_PRODUCTS = "http://sultantec.com/haraj_elbel/Notification.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            JSONArray array_2 = jsonObject.getJSONArray("Notification");
                          ...
                          //  JSONObject jo = array_2.getJSONObject(0);
                            ...
                            ProductsAdapter2not adapter = new ProductsAdapter2not(Noti.this, productList);
    ...
    private void regect2() {
        ...
        mProgressDialog = ProgressDialog.show(Noti.this,
...
String url="http://sultantec.com/haraj_elbel/Delete_Favorite.php";
            ...
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if (query_result.equals("Success")) {
                        ...
                        Toast.makeText(Noti.this, "تمت تفريغ المفضلة" , Toast.LENGTH_LONG).show();
onBackPressed();
                    } else if (!query_result.equals("Success")) {
                        mProgressDialog.dismiss();
                        Toast.makeText(Noti.this, "لم تتم  تفريغ المفضلة" +query_result, Toast.LENGTH_LONG).show();
                    }
                    ...
                    mProgressDialog.dismiss();
                    Toast.makeText(Noti.this, "لم تتم  تفريغ المفضلة"+e , Toast.LENGTH_LONG).show();
                    e.printStackTrace();
            ...
            public void onErrorResponse(VolleyError volleyError) {
                mProgressDialog.dismiss();
                Toast.makeText(Noti.this, "لم تتم  تفريغ المفضلة"+volleyError , Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams()
        ...
        Volley.newRequestQueue(Noti.this).add(stringRequest);
    }
...
//                "جاري ...","عملية التفريغ", false, false);
        ...
        //  String url = "https://sultantec.com/bisha/del_fev.php?a="+in;
        String url = "http://sultantec.com/haraj_elbel/Read_Notification.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                try {
                  ...
                  //  Toast.makeText(Noti.this, "...."+query_result2 , Toast.LENGTH_LONG).show();



                    //   Toast.makeText(mContext, "Reponse : " + array_2, Toast.LENGTH_SHORT).show();
                    if (query_result2.equals("Success")) {
                        //    mProgressDialog.dismiss();
                     //   Toast.makeText(Noti.this, "لم تقم بالاضافة الى المفضلة", Toast.LENGTH_LONG).show();

                        //  onBackPressed();
//                        wwww21.setBackgroundResource(R.drawable.ic_favorite_black_24dp2);
//                        wwww21.setEnabled(false);
                    } else if (!query_result2.equals("Success")) {
                        //  mProgressDialog.dismiss();
                    ...
                    //  rdr2.setVisibility(View.GONE);
                    // mProgressDialog.dismiss();
                    Toast.makeText(Noti.this, ""+e , Toast.LENGTH_LONG).show();
                    e.printStackTrace();
            ...
            public void onErrorResponse(VolleyError volleyError) {
                //  mProgressDialog.dismiss();
                Toast.makeText(Noti.this, "vooly"+volleyError , Toast.LENGTH_LONG).show();
            }
        })   {
            @Override
            protected Map<String, String> getParams()
           ...
           String     ph = settings.getString("go1", "44");
